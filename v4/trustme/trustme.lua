...
addon.name      = 'TrustMe'
addon.version   = '1.1'
addon.desc      = 'Lists trusts you have not yet obtained'
...
local TrustData = T{
    ...
    [1000] = {name = "unknown!", DoNotCheck = true},
    [1001] = {name = "unknown!", DoNotCheck = true},
    [1002] = {name = "unknown!", DoNotCheck = true},
...
ashita.events.register('command', 'command_cb', function (e)
    ...
    if #args == 0 or not args[1]:any('/trustme') then
        return;
    end
